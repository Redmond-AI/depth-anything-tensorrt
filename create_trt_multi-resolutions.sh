...
for i in $(seq 1 $iterations); do
    ...
    # Convert ONNX to TRT
    PYTHONPATH=. python trt_build_engine.py --onnx depth_anything_v2_vitg_4090_${size}/depth_anything_v2_vitg_4090_${size}.onnx --engine depth_anything_v2_vitg_4090_${size}.trt --tf32 --workspace 20
